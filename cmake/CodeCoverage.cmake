...
#				test_driver         # Name of the test driver executable that 
                                    # runs the tests.
#									# NOTE! This should always have a ZERO as 
                                    # exit code otherwise the coverage 
...
FUNCTION(SETUP_TARGET_FOR_COVERAGE _targetname _testrunner _outputname)
	...
	ADD_CUSTOM_TARGET(${_targetname}
		...
		COMMAND ${LCOV_PATH} --remove ${LCOV_REMOVE} --output-file ${_outputname}.info.cleaned
